...
There is also a simple python script available ([lrlx_plot_script_py2.py](https://github.com/bersavosh/XRB-LrLx_pub/blob/master/lrlx_plot_script_py2.py) and [lrlx_plot_script_py3.py](https://github.com/bersavosh/XRB-LrLx_pub/blob/master/lrlx_plot_script_py3.py)) which utilizes [Matplotlib](https://matplotlib.org/) to produces [this plot](https://github.com/bersavosh/XRB-LrLx_pub#the-lr-lx-plot-with-sources-markedcolored-by-class).
